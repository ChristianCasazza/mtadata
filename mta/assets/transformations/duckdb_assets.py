# mta/assets/transformations/duckdb_assets.py

from dagster import asset, AssetExecutionContext
import duckdb
import os
from mta.constants import MTA_ASSETS_PATHS, WEATHER_ASSETS_PATHS, LAKE_PATH
...
def create_duckdb_and_views(context: AssetExecutionContext):
