...
original_duckdb_file = os.path.join(script_dir, 'mta.duckdb')
query_folder = os.path.join(script_dir, 'sql')
new_duckdb_file = os.path.join(script_dir, '/home/christianocean/mta/mtastats/sources/mta/mtastats.duckdb')
