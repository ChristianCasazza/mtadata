...
def main():
    ...
    update_descriptions_for_table(conn, 'mta_subway_origin_destination_2023', descriptions_mta_subway_origin_destination_2023)
    update_descriptions_for_table(conn, 'mta_daily_ridership', descriptions_mta_daily_ridership)
    update_descriptions_for_table(conn, 'mta_hourly_subway_socrata', descriptions_mta_hourly_subway_socrata)
    update_descriptions_for_table(conn, 'mta_operations_statement', descriptions_mta_operations_statement)
